...
-- Find the "CampsiteOrigin" part.
local target_part = Workspace:WaitForChild("StaticMap"):WaitForChild("Campsite"):WaitForChild("CampsiteOrigin")
...
if target_part then
	...
	platform.CanCollide = true -- The change to make the platform solid
	...
	warn("Could not find CampsiteOrigin part. Cannot create platform or teleport.")
end
